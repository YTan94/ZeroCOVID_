clear all
clc
%The effect of testing and tracing can be investigated from this code by
%changing test round and percentage tacing
FJ_data = xlsread('Zero_China_data');

FJ_case=FJ_data(1:17,5);
FJ_daily_case=FJ_data(1:17,4);
