...
X_city_wideT8(:,1)=[5;daily_new_model_sim];
X_city_wideT8(:,2)=[0;X1(:,13)];

TT=500
plot((1:length(X_city_wideT8(1:TT,1)))+9, X_city_wideT8(1:TT,1) ,'color',[0.4940 0.1840 0.5560],'linewidth',1.5)


save X_city_wide_T8 X_city_wideT8
