...
FJ_case=FJ_data(1:25,5);
FJ_daily_case=FJ_data(1:25,4);

data0=length(FJ_case);

      %        b    tau_1  tau_2  a  gamma_A T   T_Q  eta    alpha gamma_d  gamma_H  xi1  xi2  u1  u2        P_D
par2=[2222732767 0.75   2      2    0.8   1/6  3  28    0.67    1     7       11     2.34 1.32  7   15      0.18   ];
...
%% plot
N_p=X_city_wide(:,1)+X_city_wide(:,2)+X_city_wide(:,3)+X_city_wide(:,4)+X_city_wide(:,5);
Z_PCR=1/T*(N-X_city_wide(:,13));

M_A=X_city_wide(:,4)/N_p*Z_PCR*eta*alpha;
M_I1=X_city_wide(:,3)/N_p*Z_PCR*eta*alpha;
M_I2=X_city_wide(:,5)/N_p*Z_PCR*alpha;
...
set(hAXTo(1),'XLim',[0 26])
set(hAXTo(2),'XLim',[0 26])
...
hxl1=xline(22,'-.','8 rounds','DisplayName','Trigger','LabelVerticalAlignment','middle','linewidth',1.5)
hxl2=xline(19,'-.','7 rounds','DisplayName','Trigger','LabelVerticalAlignment','middle','linewidth',1.5)
hxl3=xline(16,'-.','6 rounds','DisplayName','Trigger','LabelVerticalAlignment','middle','linewidth',1.5)
hxl4=xline(13,'-.','5 rounds','DisplayName','Trigger','LabelVerticalAlignment','middle','linewidth',1.5)
hxl5=xline(10,'-.','4 rounds','DisplayName','Trigger','LabelVerticalAlignment','middle','linewidth',1.5)
hxl6=xline(7,'-.','3 rounds','DisplayName','Trigger','LabelVerticalAlignment','middle','linewidth',1.5)
hxl7=xline(4,'-.','2 rounds','DisplayName','Trigger','LabelVerticalAlignment','middle','linewidth',1.5)
hxl8=xline(1,'-.','1 rounds','DisplayName','Trigger','LabelVerticalAlignment','middle','linewidth',1.5)
