...
ylabel=['CTTI testing adherence rate       ';'Days per round of testing         ';'Tracing percentage                ';...
    'Free transmission days            ';'Testing efficiency                ';'Symptomatic testing adherence rate'];
