function xdot = Zero_s2(tn,x,par1,par2,c_d,c_s)
...
xdot=[-beta*c2*(I1+b*A+I2)*S/N_p-Z_s+1/T_Q*Qs; %S 1
    beta*c2*(I1+b*A+I2)*S/N_p-1/tau_1*(E-Z_E)-Z_E;  %2 E
    ...
    M_I1+M_A+M_I2]; % new citywide tested 16
