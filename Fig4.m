...
% hold on
plot(1:0.1:length(ode_testcd80_T5(1:10:end)),ode_testcd80_T5,'color',[1 0 1],'linewidth',1.5)
hold on
plot(1:0.1:length(ode_testcd80_T4(1:10:end)),ode_testcd80_T4,'color',[0.87 0.63 0.87],'linewidth',1.5)
hold on

plot(1:0.1:length(ode_testcd80_T3(1:10:end)),ode_testcd80_T3,'color',[0.53 0.81 0.92],'linewidth',1.5)
hold on
...
hxl2=xline(27,'-.','9 rounds','DisplayName',' ','LabelVerticalAlignment','middle','linewidth',1.5)
hxl3=xline(36,'-.','9 rounds','DisplayName',' ','LabelVerticalAlignment','middle','linewidth',1.5)
hxl4=xline(65,'-.','13 rounds','DisplayName',' ','LabelVerticalAlignment','middle','linewidth',1.5)
...
xticks([1 27 36 65  ])
xticklabels({'Sep 10','Oct 6','Oct 15','Nov 13'})
%xlim([0 225])
%% 
%% plot
subplot(322)
...
% hold on
plot(1:0.1:length(X_city_wide_cd80_T5(1:10:end,13)),X_city_wide_cd80_T5(:,13),'color',[1 0 1 ],'linewidth',2)
hold on
plot(1:0.1:length(X_city_wide_cd80_T4(1:10:end,13)),X_city_wide_cd80_T4(:,13),'color',[0.87 0.63 0.87],'linewidth',2)
hold on
...
plot(1:0.1:length(ode_testcd60_T4(1:10:end)),ode_testcd60_T4,'color',[1 0.38 0 ],'linewidth',1.5)
hold on

plot(1:0.1:length(ode_testcd70_T4(1:10:end)),ode_testcd70_T4,'color',[0.9290 0.6940 0.1250],'linewidth',1.5)
hold on
...
hxl3=xline(44,'-.','11 rounds','DisplayName',' ','LabelVerticalAlignment','middle','LabelHorizontalAlignment', 'left','linewidth',1.5)
hxl4=xline(48,'-.','12 rounds','DisplayName',' ','LabelVerticalAlignment','middle','linewidth',1.5)
%hxl5=xline(205,'-.','41 rounds','DisplayName',' ','LabelVerticalAlignment','middle','linewidth',1.5)
...
xticks([1 36 44 48  ])
xticklabels({'Sep 10','Oct 15','Oct 23','Oct 27'})
%xlim([0 200])
%%
subplot(324)
...
plot(1:0.1:length(X_city_wide_cd70_T4(1:10:end,13)),X_city_wide_cd70_T4(:,13),'color',[0.9290 0.6940 0.1250],'linewidth',2)
hold on
...
ylabel('Cumulative isolated cases')
xlabel('2021')
title('(d)')
...
% plot(1:0.1:length(ode_testcd60_T5(1:10:end)),ode_testcd60_T5,':','color',[0.89 0.09 0.05],'linewidth',2)
% hold on

plot(1:0.1:length(ode_testcd100_T5(1:10:end)),ode_testcd100_T5,'-.','color',[0.9290 0.6940 0.1250],'linewidth',2)
hold on

plot(1:0.1:length(ode_testcd50_T3(1:10:end)),ode_testcd50_T3,'--','color',[0.2 0.63 0.79],'linewidth',2)

legend('5 days/round, 100% tracing',...
   ' 3 days/round, 50% tracing')
...
hxl1=xline(30,'-.','10 rounds','DisplayName','Clear cases ','LabelVerticalAlignment','middle','LabelHorizontalAlignment', 'left','linewidth',1.5)
hxl2=xline(50,'-.','10 rounds','DisplayName',' ','LabelVerticalAlignment','middle','LabelHorizontalAlignment', 'left','linewidth',1.5)
hxl3=xline(205,'-.','41 rounds','DisplayName',' ','LabelVerticalAlignment','middle','LabelHorizontalAlignment', 'left','linewidth',1.5)
...
xticks([1  30 50  205])
xticklabels({'Sep 10, 2021','Oct 9','Oct 29','Apr 2, 2022'})
...
% plot(1:0.1:length(X_city_wide_cd60_T5(1:10:end,13)),X_city_wide_cd60_T5(:,13),':','color',[0.89 0.09 0.05],'linewidth',2)
% hold on


plot(1:0.1:length(X_city_wide_cd100_T5(1:10:end,13)),X_city_wide_cd100_T5(:,13),'--','color',[0.9290 0.6940 0.1250],'linewidth',2)
hold on



plot(1:0.1:length(X_city_wide_cd50_T3(1:10:end,13)),X_city_wide_cd50_T3(:,13),'-.','color',[0.2 0.63 0.79],'linewidth',2)
